...
<body>
     <div class="container-fluid">
         <h1 class="mt-4">Detail Penyewa</h1>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="card bg-info text-white">
                    ...
                    <h5>Penyewaan</h5>
                        <div class="mt-1 mb-4">
                            Tanggal : {{$checkout->created_at}}<br>
                            Total : Rp. {{$checkout->total}} <br>
                        </div>
                        </div>
                 </div>
             </div>
                                    ...
                                    <div id="offline_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                    ...
                                                    <thead>
                                                        <tr class="text-center" role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="offline"
                                                                ...
                                                                aria-label="NIK: activate to sort column ascending">Jumlah
                                                            </th>
                                                            <th class="sorting" tabindex="0" aria-controls="offline"
                                                                rowspan="1" colspan="1" style="width: 111px;"
                                                                aria-label="NIK: activate to sort column ascending">Subtotal
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    @php $i = 1; @endphp
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-5">
                                                <div class="dataTables_info" id="offline_info" role="status"
