...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Add New Data Pelanggan</h2>
        </div>
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('penyewas.index') }}"> Back</a>
        </div>
    </div>
</div>
...
<form action="{{ route('penyewas.store') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>No_hp:</strong>
                <textarea class="form-control" style="height:150px" name="no_hp" placeholder="no_hp"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
